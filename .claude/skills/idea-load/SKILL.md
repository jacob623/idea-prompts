---
name: "idea-load"
description: "Loads a session by slug and sets it as the active session, visibly in chat."
metadata:
...
Read `.idea/library/instructions/load.md` in full and follow its procedure exactly. If the file is absent, tell the user: "Instruction file not found at `.idea/library/instructions/load.md`. Run `/idea.init` to restore the instructions library, then run this skill again."
